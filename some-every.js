...
function hasAZero(num) {
    ...
    return numStr.split('').some(char => char === '0');
}
console.log(hasAZero(2123213101232321)) // true
...
accepts an array and returns true if there are 
no duplicate values 
(more than one element in the array that has 
